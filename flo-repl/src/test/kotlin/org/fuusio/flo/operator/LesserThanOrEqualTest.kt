...
internal class LesserThanOrEqualTest : AbstractTest() {
    ...
    inner class ExecuteWithParameters {
        ...
        @Test
        @DisplayName("With parameters 10 and 10, Then should return true")
        fun withParameters10And32() {
            val expectedResult = true
            ctx.push(10)
            val result = Executor.execute(ctx, 32, LesserThanOrEqual)
